...
@Preview(showBackground = true, showSystemUi = true, uiMode = UI_MODE_NIGHT_YES, name = "Success")
@Composable
fun MoviesScreenSuccessPreview() {
    FilmoTheme {
        MoviesScreen(uiState = MoviesUiState.Success(Movies(dummyMovies, dummyMovies, dummyMovies)))
    }
}
